...
export function ChatArea({ messages, status }: ChatAreaProps) {
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="text-center max-w-xl">
          <div className="w-16 h-16 rounded-xl overflow-hidden bg-slate-800 border border-slate-700 flex items-center justify-center mx-auto mb-4">
            <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
            <div className="p-3 bg-blue-700/20 border border-blue-700/30 rounded-lg">
              <h3 className="font-semibold text-blue-300 mb-1.5 text-sm">Hardware Specs</h3>
            ...
            <div className="p-3 bg-emerald-700/20 border border-emerald-700/30 rounded-lg">
              <h3 className="font-semibold text-emerald-300 mb-1.5 text-sm">Quick Setup</h3>
              <p className="text-slate-400 text-xs">
            ...
            <div className="p-3 bg-amber-700/20 border border-amber-700/30 rounded-lg">
              <h3 className="font-semibold text-amber-300 mb-1.5 text-sm">Development</h3>
              <p className="text-slate-400 text-xs">
          ...
          <div className="mt-6 p-3 bg-slate-850/50 border border-slate-800 rounded-lg">
  ...
  {(status === 'submitted' || (status === 'streaming' && (!lastAssistantId || !lastAssistantHasContent))) && (
          <div className="flex items-start gap-3">
            <div className="w-7 h-7 rounded-full overflow-hidden bg-slate-800 border border-slate-700 flex items-center justify-center flex-shrink-0">
              <img 
                src="/beagleboard-logo.png" 
                alt="BeagleBoard Logo" 
            ...
            <div className="flex-1">
              <div className="bg-slate-850/50 rounded-xl rounded-tl-sm p-3 border border-slate-800/50">
                <LoadingDots />
              </div>
            </div>
          </div>
  ...
  {!autoScroll && (
        <button
          ...
          className="absolute bottom-3 right-3 z-10 px-2.5 py-1.5 rounded-full bg-neutral-800/80 border border-neutral-700 text-xs text-neutral-200 flex items-center gap-1 shadow hover:bg-neutral-700 backdrop-blur"
        >
